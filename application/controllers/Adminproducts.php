...
//print_r($inserdata);
	...
	if(!empty($storesingle)){
		...
		$data1= array('prod_store_id' =>$storesingle,'prod_cat_id' =>$prodcategoryid,'prod_sub_cat_id' =>$subprodcategoryid,'prod_brand_id' =>$brand,'prod_agent_id' =>0,'prod_priority' =>$display,'prod_code' =>$productcode,'prod_name' =>$prodname,'prod_rate' =>$productrate,'prod_purchase_rate' =>$purchaserate,'prod_descr' =>$productdesc,'prod_disc' =>$productdiscount,'prod_disc_price' =>$productdiscountprice,'prod_sell_price' => $sellprice,'prod_uom' =>$productmeasureunit,'prod_tax' =>$tax,'prod_image' =>$filename,'prod_deactive' =>$productavailable,'prod_admin_approved' =>$approval,'prod_addedcomm' =>$prodaddedcomm,'prod_commission' =>$productcomm,'prod_modified' =>$date,'prod_short_desc' =>$product_short_desc,'prod_rating' =>$product_rating );
	}else{
		$data1=array();
	}
