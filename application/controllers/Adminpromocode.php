    ...
    public function insert_promocode()
		{
	 			 ...
	 			 $data1= array('promo_code' =>$code ,'promo_discount'=>$percentage,'promo_type ' => $code_type,'promo_expiry' => $exp_date,'promo_max_amount'=>$max_amount,'promo_min_cart_value' => $min_cart,'promo_status '=>$promo_status,'promo_created '=>$date );
