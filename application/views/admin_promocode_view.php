                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6">
                      <h4 class="demo-sub-title">Code Type </h4>
                       <select class="form-control" name="code_type" onchange="show_percentage();" required="required" id="code_type">
                     ...
                     <div class="form-group col-sm-6" id="percentage_input" style="display: none;">
                      <h4 class="demo-sub-title">Discount Percentage</h4>
