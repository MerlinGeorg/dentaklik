 ...
 <!-- <script src="<?php echo base_url(); ?>/templateadmin/assets/scripts/demo/bar-chart.js"></script> -->
        ...
        <div class="container-fluid" style="height: 100%;overflow-y: auto;">
          <div class="row panel-wrapper js-grid-wrapper" >
            <div class="col-xs-12 col-sm-6 col-md-3 js-grid js-sizer"><a href="<?php echo base_url();?>index.php/adminproducts">
                ...
                <div class="widget widget-v bg-primary">
                  ...
                  <div class="w-section">
                    <!-- <div class="small">USERS</div> -->
                      ...
                      <div class="small">AGENTS</div><div class="display-6"><?php if(!empty($allusers))
                      foreach($allusers as $user){
                        echo $user->user;
                      } ?></div>
                      <div class="small">USERS</div><div class="display-6"><?php if(!empty($allusers)) foreach($allusers as $user){
                        echo $user->agent;
                      } ?></div>
                ...
                <div class="widget widget-v bg-aqua">
                  ...
                  <div class="w-section">
                    <!-- <div class="small">USERS</div> -->
                      ...
                      <div class="small">STORES</div><div class="display-6"><?php echo $countstores;?></div>
                      <!-- <div class="small">USERS</div><div class="display-6"><?php if(!empty($allusers)) echo $allusers[1]->user ?></div> -->
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 js-grid js-sizer" ><a href=" <?php echo base_url();?>index.php/admin_bannerslide" >
                <div class="widget widget-v bg-warning">
                  ...
                  <div class="w-section">
                      ...
                      <div class="small">PENDING SLIDERS/BANNERS VERIFIFICATION</div><div class="display-6"><?php echo $countbanslide;?></div>
                  </div>
                </div></a></div>
<!--               <div class="col-xs-12 col-sm-6 col-md-3 js-grid js-sizer" ><a href=" <?php echo base_url();?>index.php/adminbrandmanage" >
              ...
              <div class="col-xs-12 col-sm-6 col-md-3 js-grid js-sizer" style="cursor: default;">
                <div class="widget widget-v bg-success">
                  <div class="w-main w-center bg-success-lighten"><i class="fa fa-object-ungroup"></i></div>

                  <div class="w-section">
                      <div class="small">TOTAL COMMISSION</div><div class="display-6"><?php echo number_format($totalcommission->newvalue,2, '.', '');?></div>
                  </div>
                </div></div>


<!--                 <?php foreach($allstores as $stores){?>
              <div class="col-xs-12 col-sm-6 col-md-3 js-grid js-sizer" ><a style="cursor: pointer;"onclick="storescal(<?php echo $stores->store_id;?>);" >
                <div class="widget widget-v bg-warning">
                  <div class="w-main w-center bg-warning-lighten"><i class="fa fa-shopping-bag"></i></div>

                  <div class="w-section">
                   
                   
                      <div class="small">STORE</div><div class="display-6"><?php echo $stores->store_name;?></div>
 ...
 <!--  -->
  <!--           <div class="col-xs-12 col-sm-6 col-md-6 js-grid " >
              <div class="panel">
                <div class="panel-body">
                  <div class="legend legend-inline pull-xs-right" id="demo-bar-chart-legend"></div>
