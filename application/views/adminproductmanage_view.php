                ...
                <div class="panel-body">
                  ...
                  <div class="row m-b-2">
                    ...
                    <div class="form-group col-sm-6" style="display: none;">
                      ...
                      <input class="form-control " type="text"  name="productcomm" id="productcomm" pattern="[0-9]+" title="only numbers allowed" value = "1">
                    </div>
...
<!--                     <div class="form-group col-sm-6">
                   ...
                   <div class="row m-b-2">
                    <div class="form-group col-sm-6">
                      ...
                      <input class="form-control " type="text" required="required" name="producttax" id="producttax" pattern="[0-9.]+" title="only numbers allowed">
                    </div>
                ...
                <?php }?>
                   ...
                   <div class="row m-b-2">
                     ...
                     <div class="form-group col-sm-6">
                      ...
                      <input class="form-control " type="text" required="required" name="product_rating"  id="product_rating">
                    </div>
                  </div>
