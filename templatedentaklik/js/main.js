		 ...
		 if(tpj("#rev_slider_two").revolution == undefined){
			...
			sliderType:"standard",
                ...
                navigation: {
                 ...
                 gridwidth:[1200,1040,800,800],
                 gridheight:[690,650,400,400],
                 lazyType:"none",
                 parallax: {
                     type:"scroll",
                     origo:"enterpoint",
...
// product view mode change js
		$('.product-view-mode a').on('click', function(e){
			...
			var shopProductWrap = $('.ps-block__product-box');
    ...
    // product view mode change js
		$('.featured-view a').on('click', function(e){
			e.preventDefault();
			
			var shopProductWrap = $('.ps-block__product-box');
			var viewMode = $(this).data('target');
			
			$('.featured-view a').removeClass('active'); 
			$(this).addClass('active');
			shopProductWrap.removeClass('grid list column_4').addClass(viewMode);
		})
...
// product view mode change js
		$('.product-view-mode a').on('click', function(e){
			...
			var shopProductWrap = $('.ps-shopping-product');
			var viewMode = $(this).data('target');
